...
if [ ! -d cache ]; then
  mkdir cache cache/doc cache/tmp cache/txt cache/xml cache/log cache/doc/orig cache/doc/temp cache/doc/thmb cache/doc/work cache/tmp/gen cache/tmp/img cache/tmp/ing cache/tmp/txt cache/tmp/upl cache/tmp/xml cache/xml/cache cache/xml/data;
