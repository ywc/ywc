...
YWC.f.popupGenerateHtml = function(inputParams) {
	...
	var dragBufferOuter = '<img src="'+YWC.uri.pre+'lib/ywc-image/1.0/core/trans.gif"'
	...
	+'<div class="popup-loading" style="'
		...
		+'height:'+minHeight+'px;'
		+'">'
		+'<img src="'+YWC.uri.pre+'lib/ywc-image/1.0/anim/spin-01.gif" style="'
			+'top:'+Math.round((minHeight-width/5)/2)+'px;'
			+'left:'+Math.round(2*width/5)+'px;'
